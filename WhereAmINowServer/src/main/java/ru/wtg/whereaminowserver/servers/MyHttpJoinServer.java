 ...
 * Created 1/19/17.
 */
public class MyHttpJoinServer implements HttpHandler {

    private volatile AbstractWainProcessor wainProcessor;
    private DatabaseReference ref;

    public MyHttpJoinServer(){
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        System.out.println("Joining server requested");
...
//        html.getHead().add(SCRIPT).with(SRC, "/js/Utils.js");
        ...
        getWainProcessor().onMessage(null, body);
